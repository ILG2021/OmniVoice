...
| `--tokenizer_path` | `k2-fsa/OmniVoice` | HuggingFace repo or local path; if the repo contains an `audio_tokenizer` subfolder it is used automatically. Can be omitted to use the default. |
